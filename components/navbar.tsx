...
const Navbar = () => {
    ...
    return (
        <>
            <nav className="sticky flex justify-between items-center dark:bg-slate-800 dark:text-white px-6 lg:px-20 3xl:px-0 z-30 py-5 shadow-lg shadow-gray-600">
                <Link href="/">
                    <Image src="/logo.png"
                ...
                {colorTheme === "light" ? (
                    ...
                    className="h-10 w-10 text-indigo-200 block"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                    ...
                    <svg
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-10 w-10 text-gray-900 block"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                    >
