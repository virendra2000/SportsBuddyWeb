        ...
        <>
            <section className="p-5 h-auto bg-slate-100 dark:bg-slate-800 w-full flex flex-col items-center justify-center text-center">
                ...
                <Link href="/">
                    ...
                    icon="/home.gif"
                    variant="m-2 px-2 py-2 w-full rounded-full border-0 font-bold bg-black dark:bg-white text-white dark:text-black cursor-pointer dark:hover:bg-black dark:hover:text-white shadow-md hover:shadow-black dark:hover:shadow-black"/>
                </Link>
            </section>
        </>
    )
